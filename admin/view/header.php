...
if (isset($_SESSION['s_user']) && (count($_SESSION['s_user']) > 0)) {
    ...
    $html_account = '     
        ...
        <span class="profile-name"> ' . $ho_ten . '</span>
        </a>      
       ';
...
<head>
    ...
    <link rel="shortcut icon" href="./admin/view/view/img/favicon.png">
    <style type="text/css">
        /* Chart.js */
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <div class="text-center sidebar-brand-wrapper d-flex align-items-center">
                <a class="sidebar-brand brand-logo" href="index.php">
                    <img style="width:150px;height: 80px; margin-bottom: 10px; " src="view/images/logo-main.jpg" alt="logo"></a>
                <a class="sidebar-brand brand-logo-mini pl-4 pt-3" href="#">
                    <img style="width:150px;height: 80px; margin-bottom: 10px; " src="./admin/view/images/logo-main.jpg" alt="logo"></a>
            </div>
            <ul class="nav">
