                    ...
                    <div class="product-details-images slider-navigation-1">
                        <div class="lg-image">
                            <a class="popup-img venobox vbox-item" href="images/product/large-size/1.jpg"
                                data-gall="myGallery">
                                <img src="layout/images/sanpham/<?= $hinh_anh ?>" alt="product image">
                            </a>
                        </div>
                        <div class="lg-image">
                                        ...
                                        <div class="modal-inner-area row">
                                            <div class="col-lg-6">
                                                <div class="li-review-product">
                                                    <img src="layout/images/sanpham/<?= $hinh_anh ?> "
                                                        alt="Li's Product">
                                                    <div class="li-review-product-desc">
                                                        <p class="li-product-name"><?= $ten_sp ?></p>
                                                        <p>
                                                            <span>
                                                                <?= $mo_ta ?>
                                                            </span>
                                                ...
                                                <div class="li-review-content">
                                                    ...
                                                    <div class="feedback-area">
                                                        <div class="feedback">
                                                            ...
                                                            <form action="index.php?pg=chitietsanpham">
                                                                <input type="hidden " name="sanpham_id" value="<?= $id ?>">
                                                                <p class="your-opinion">
                                                                    <label>Đánh giá của bạn</label>
                                                                    <span>
                                                                        <select class="star-rating">
                                                                            <option name="saodg" value="1">1</option>
                                                                            <option name="saodg" value="2">2</option>
                                                                            <option name="saodg" value="3">3</option>
                                                                            <option name="saodg" value="4">4</option>
                                                                            <option name="saodg" value="5">5</option>
                                                                        </select>
                                                                    </span>
                                                                </p>
                                                                ...
                                                                <div class="feedback-input">
                                                                    <p class="feedback-form-author">
                                                                        ...
                                                                        <input id="author" name="ten_binhluan" value="<?= $nguoi_dung_ten?> "
                                                                    ...
                                                                    <p class="feedback-form-author feedback-form-email">
                                                                        ...
                                                                        <input id="email" name="email_binhluan" value="<?= $nguoi_dung_email?>"
                                                                            size="30" aria-required="true" type="email">
                                                                    ...
                                                                    <div class="feedback-btn pb-15">
                                                                       ...
                                                                       <button type="submit" name="binhluan" >nhập</button>
                                                                    </div>
                                                                </div>
                                                            </form>
                                                        </div>
