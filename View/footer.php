                        ...
                        <div class="footer-shipping pt-60 pb-55 pb-xs-25">
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 pb-sm-55 pb-xs-55">
                                    <div class="li-shipping-inner-box">
                                        <div class="shipping-icon">
                                            <img src="layout/images/shipping-icon/1.png" alt="Shipping Icon">
                                        </div>
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 pb-sm-55 pb-xs-55">
                                    <div class="li-shipping-inner-box">
                                        <div class="shipping-icon">
                                            <img src="layout/images/shipping-icon/2.png" alt="Shipping Icon">
                                        </div>
                                        <div class="shipping-text">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 pb-xs-30">
                                    <div class="li-shipping-inner-box">
                                        <div class="shipping-icon">
                                            <img src="layout/images/shipping-icon/3.png" alt="Shipping Icon">
                                        </div>
                                        <div class="shipping-text">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 pb-xs-30">
                                    <div class="li-shipping-inner-box">
                                        <div class="shipping-icon">
                                            <img src="layout/images/shipping-icon/4.png" alt="Shipping Icon">
                                        </div>
                                        <div class="shipping-text">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="footer-logo logo-img">
                                        <img class="" src="layout/images/menu/logo/logo-main.jpg" alt="Footer Logo">
                                        <p class="info">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="copyright text-center">
                                    <a href="#">
                                        <img src="layout/images/payment/1.png" alt="">
                                    </a>
                                </div>
                                   ...
                                   <!-- Product Details Left -->
                                    <div class="product-details-left">
                                        <div class="product-details-images slider-navigation-1">
                                            <div class="lg-image">
                                                <img src="layout/images/product/large-size/1.jpg" alt="product image">
                                            </div>
                                            <div class="lg-image">
                                        ...
                                        <div class="product-details-thumbs slider-thumbs-1">                                        
                                            <div class="sm-image"><img src="layout/images/product/small-size/1.jpg" alt="product image thumb"></div>
                                            <div class="sm-image"><img src="layout/images/product/small-size/2.jpg" alt="product image thumb"></div>
                                            <div class="sm-image"><img src="layout/images/product/small-size/3.jpg" alt="product image thumb"></div>
                                            <div class="sm-image"><img src="layout/images/product/small-size/4.jpg" alt="product image thumb"></div>
                                            <div class="sm-image"><img src="layout/images/product/small-size/5.jpg" alt="product image thumb"></div>
                                            <div class="sm-image"><img src="layout/images/product/small-size/6.jpg" alt="product image thumb"></div>
                                        </div>
                                    </div>
                                    <!--// Product Details Left -->
                                </div>
