        ...
        <div class="single-product-wrap">
            ...
            <div class="product_desc">
                <div class="product_desc_info">
                    ...
                    <div class="price-box">
                        <span class="new-price"> '.number_format($gia,0,',','.').' VNĐ</span>
...
function showspli($dssp){
    $html_dssp='';
    foreach ($dssp as $sp) {
        extract($sp);
        $html_dssp.='<div class="product-img">
        <a href="index.php?pg=chitietsanpham&id='.$id.'">
            <img alt="" src="layout/images/sanpham/'.$hinh_anh.'">
        </a>
        </div>
        <div class="featured-pro-content">
        <div class="product-review">
            <h5 class="manufacturer">
                <a href="index.php?pg=chitietsanpham&id='.$id.'">Studio Design</a>
            </h5>
        </div>
        <div class="rating-box">
            <ul class="rating">
        ...
        <h4><a class="featured-product-name" href="single-product.html">'.$ten_sp.'</a></h4>
        <div class="featured-price-box">
            <span class="new-price new-price-2">' .number_format($gia,0,',','.'). '</span>
